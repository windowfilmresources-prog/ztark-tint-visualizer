...
def mats():
    ...
    _M.update({
        ...
        "foliage":  _principled("Foliage", (0.25, 0.41, 0.22), roughness=0.8),
        "lawn":     _principled("Lawn", (0.42, 0.55, 0.33), roughness=0.9),
        "trunk":    _principled("Trunk", (0.34, 0.24, 0.15), roughness=0.85),
