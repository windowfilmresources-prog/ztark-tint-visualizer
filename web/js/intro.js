...
(function () {
  ...
  var ROAD_SVG =
    '<svg class="bi-roadsvg" viewBox="0 0 1200 348" aria-hidden="true"><defs><mask id="biM0"><path d="M 30 288 L 60 265 L 90 250 L 120 238 L 150 228 L 180 220 L 210 214 L 240 208 L 270 195 L 300 140 L 330 85 L 360 76 L 390 69 L 420 63 L 450 59 L 480 55 L 510 52 L 540 51 L 570 49 L 600 48 L 630 47 L 660 47 L 690 47 L 720 47 L 750 47 L 780 48" pathLength="1" stroke-dasharray="1" stroke-dashoffset="1" fill="none" stroke="#fff" stroke-width="310" stroke-linecap="round" stroke-linejoin="round" class="bi-spine bi-spine0"/></mask><mask id="biM1"><path d="M 420 220 L 450 225 L 480 229 L 510 222 L 540 207 L 570 203 L 600 204 L 630 204 L 660 197 L 690 183 L 720 140 L 750 73 L 780 70 L 810 68 L 840 66 L 870 64 L 900 64 L 930 64 L 960 64" pathLength="1" stroke-dasharray="1" stroke-dashoffset="1" fill="none" stroke="#fff" stroke-width="320" stroke-linecap="round" stroke-linejoin="round" class="bi-spine bi-spine1"/></mask><mask id="biM2"><path d="M 660 192 L 690 197 L 720 203 L 750 208 L 780 231 L 810 243 L 840 250 L 870 255 L 900 259 L 930 265 L 960 272 L 990 274 L 1020 285 L 1050 302 L 1080 320 L 1110 323 L 1140 325 L 1170 328" pathLength="1" stroke-dasharray="1" stroke-dashoffset="1" fill="none" stroke="#fff" stroke-width="300" stroke-linecap="round" stroke-linejoin="round" class="bi-spine bi-spine2"/></mask></defs><g mask="url(#biM0)"><g transform="translate(0,348) scale(0.1,-0.1)"><path d="M5455 3059 c-1083 -30 -2107 -165 -2817 -370 -919 -265 -1573 -655 -2043 -1219 -222 -267 -421 -682 -476 -994 -20 -114 -26 -285 -10 -302 6 -5 573 -8 1512 -6 l1502 2 -49 53 c-100 106 -361 487 -441 644 -360 703 48 1361 1057 1706 717 246 1827 370 3555 397 761 12 845 17 585 36 -749 54 -1633 74 -2375 53z" fill="#ff0a0c"/></g></g><g mask="url(#biM1)"><g transform="translate(0,348) scale(0.1,-0.1)"><path d="M7640 2883 c-30 -1 -152 -7 -270 -13 -384 -19 -1125 -79 -1435 -116 -358 -42 -569 -101 -605 -168 -6 -13 -13 -48 -14 -79 -3 -75 -16 -87 -144 -138 -699 -278 -1037 -680 -991 -1180 30 -322 242 -676 579 -968 l65 -56 1284 3 1285 2 -210 126 c-708 424 -1124 775 -1220 1029 -101 271 -67 447 126 636 391 382 1084 631 2140 768 396 51 991 91 1380 91 420 1 205 22 -560 55 -290 13 -1218 18 -1410 8z" fill="#ff0a0c"/></g></g><g mask="url(#biM2)"><g transform="translate(0,348) scale(0.1,-0.1)"><path d="M9605 2704 c-33 -2 -152 -8 -265 -14 -1070 -56 -2197 -307 -2606 -580 -106 -71 -250 -218 -292 -297 -53 -101 -59 -261 -15 -398 110 -341 527 -714 1280 -1145 l191 -110 2051 0 c1195 0 2051 4 2051 9 0 5 -10 11 -22 14 -31 8 -282 56 -343 67 -398 68 -1052 192 -1900 361 -1106 220 -1764 482 -2091 832 -121 128 -153 267 -93 397 85 182 418 394 830 528 464 151 1174 259 1918 292 130 6 265 14 301 18 l65 6 -100 7 c-119 8 -874 18 -960 13z" fill="#ffcf00"/></g></g></svg>';
  ...
  css.textContent =
    ...
    "#brandIntro .bi-roadsvg{width:86%;height:auto;display:block;margin:0 auto 10px}" +
    (reduced ? "#brandIntro .bi-spine{animation:none!important;stroke-dashoffset:0!important}" : "#brandIntro .bi-spine0{animation:biDraw .55s cubic-bezier(.55,0,.25,1) 0.05s forwards}#brandIntro .bi-spine1{animation:biDraw .55s cubic-bezier(.55,0,.25,1) 0.17s forwards}#brandIntro .bi-spine2{animation:biDraw .55s cubic-bezier(.55,0,.25,1) 0.29s forwards}") +
    ...
    (reduced ? "" : "opacity:0;transform:translateY(.35em);filter:blur(5px);animation:biLetter .38s cubic-bezier(.2,.7,.2,1) forwards;") + "}" +
    (reduced ? "" : "#brandIntro .bi-l0{margin-left:2.917%;width:10.417%;aspect-ratio:0.6010;background-size:960.00% 100%;background-position-x:3.256%;animation-delay:0.55s}#brandIntro .bi-l1{margin-left:1.833%;width:10.333%;aspect-ratio:0.5962;background-size:967.74% 100%;background-position-x:16.914%;animation-delay:0.60s}#brandIntro .bi-l2{margin-left:1.333%;width:6.583%;aspect-ratio:0.3798;background-size:1518.99% 100%;background-position-x:28.724%;animation-delay:0.65s}#brandIntro .bi-l3{margin-left:1.333%;width:10.417%;aspect-ratio:0.6010;background-size:960.00% 100%;background-position-x:38.791%;animation-delay:0.70s}#brandIntro .bi-l4{margin-left:1.583%;width:10.417%;aspect-ratio:0.6010;background-size:960.00% 100%;background-position-x:52.186%;animation-delay:0.75s}#brandIntro .bi-l5{margin-left:1.083%;width:10.333%;aspect-ratio:0.5962;background-size:967.74% 100%;background-position-x:64.963%;animation-delay:0.80s}#brandIntro .bi-l6{margin-left:1.667%;width:10.333%;aspect-ratio:0.5962;background-size:967.74% 100%;background-position-x:78.346%;animation-delay:0.85s}#brandIntro .bi-l7{margin-left:1.333%;width:10.417%;aspect-ratio:0.6010;background-size:960.00% 100%;background-position-x:91.442%;animation-delay:0.90s}#brandIntro .bi-l8{margin-left:1.333%;width:3.333%;aspect-ratio:0.1923;background-size:3000.00% 100%;background-position-x:96.897%;animation-delay:0.95s}") +
    ...
    (reduced ? "opacity:0" : "animation:biGlint .8s ease-in-out 1.5s forwards") + "}" +
    ...
    (reduced ? "" : "transform:scaleX(0);animation:biLine .68s cubic-bezier(.65,0,.35,1) .6s forwards") + "}" +
    ...
    (reduced ? "opacity:.85" : "animation:biSub .6s ease 1.1s forwards") + "}" +
    ...
    "font-family:" + (cfg.font || "sans-serif") + ";opacity:0;animation:biSkip .4s ease 1.4s forwards}" +
    "@keyframes biDraw{to{stroke-dashoffset:0}}" +
    "@keyframes biLetter{to{opacity:1;transform:translateY(0);filter:blur(0)}}" +
  ...
  if (debugT) {
    ...
    setTimeout(dismiss, reduced ? 1200 : 2700);
  }
})();
