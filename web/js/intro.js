...
(function () {
  ...
  css.textContent =
    ...
    (reduced ? "#brandIntro .bi-lane{opacity:1!important;animation:none!important;will-change:auto}" : "#brandIntro .bi-lane{opacity:0;transform-origin:28% 82%;animation:biSwoop .68s cubic-bezier(.18,.9,.28,1.06) forwards}#brandIntro .bi-lane0{animation-delay:.62s}#brandIntro .bi-lane1{animation-delay:.76s;transform-origin:35% 85%}#brandIntro .bi-lane2{animation-delay:.9s;transform-origin:42% 88%}") +
    ...
    "@keyframes biSwoop{0%{opacity:0;transform:translate(-16%,34%) rotate(-8deg) scale(.72)}62%{opacity:1;transform:translate(1.6%,-2.5%) rotate(1.2deg) scale(1.025)}100%{opacity:1;transform:none}}" +
